# =============================================================================
# Jenkins Automation - Track 1A Windows (Puppet) CloudFormation Cleanup Script
# =============================================================================
# Usage: powershell.exe -ExecutionPolicy Bypass -File cleanup-track1-windows.ps1
# =============================================================================
...
Write-Host "    - EC2 Windows instance" -ForegroundColor Red
Write-Host "    - Security group" -ForegroundColor Red
Write-Host "    - Key pair (RDP password will no longer be decryptable)" -ForegroundColor Red
Write-Host ""
...
if (Test-Path .\jenkins-puppet-windows.pem) {
    ...
    Write-Ok "jenkins-puppet-windows.pem removed"
} else {
